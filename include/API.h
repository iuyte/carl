...
/**
 * This value is returned if the sensor cannot find a reasonable value to
 *****return.
 */
 ...
 * If the ultrasonic sensor was never started, the return value is undefined.
 *****Round and fluffy
...
/**
 * For convenience, FILE is defined as PROS_FILE if it wasn't already defined.
 *****This provides
 * backwards compatability with PROS, but also allows libraries such as newlib
 *****to be incorporated
 * into PROS projects. If you're not using C++/newlib, you can disregard this
 *****and just use FILE.
 */
...
/**
 * Enables the Cortex to run the op control task in a standalone mode- no VEXnet
 *****connection required.
 *
 * This function should only be called once in initializeIO()
 */
